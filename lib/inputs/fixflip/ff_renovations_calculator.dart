...
class _RenovationsCalculatorState
  ...
  GlobalKey<FormState> ffRenovationsKey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    ...
    return MyInputPage(
        ...
        onSubmit: () {
          ...
          if (ffRenovationsKey.currentState?.validate() ?? false) {
            ...
            children: (enterTotal)
                ? [
                    ...
                    IntegerTextField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'Months to Rehab & Sell is required';
                        }
                        return null;
                      },
                    ),
